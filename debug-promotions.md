# Debug Promotions Not Showing

## Possible Issues:

1. **Promotions table doesn't exist** - Need to run SQL script
2. **No active promotions** in database
3. **Promotions are expired** or inactive
...
## Expected Result:
You should see 3 sample promotions on the home screen:
1. New Customer Special (20% off)
2. Free Delivery Weekend (€5 off)
3. Holiday Special (25% off)
