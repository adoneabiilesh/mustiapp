-- Advanced Order Tracking System (FIXED VERSION 2)
-- Real-time GPS tracking, delivery photos, driver communication
-- This version ensures proper order of operations

-- ============================================================================
-- STEP 1: Create drivers table FIRST
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Add driver columns to orders table (if orders table exists)
-- ============================================================================
DO $$ 
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables 
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
      ...
      RAISE NOTICE 'Added driver_rating column to orders table';
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
      ...
      RAISE NOTICE 'Added driver_tip column to orders table';
    END IF;
    
  ELSE
    RAISE NOTICE 'Orders table does not exist yet. Skipping driver column additions.';
  END IF;
END $$;
...
-- ============================================================================
-- STEP 4: Create indexes (with safety checks)
-- ============================================================================
...
-- Create index on orders.driver_id ONLY if the column exists
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.columns 
    ...
    RAISE NOTICE 'Created index on orders.driver_id';
  ELSE
    RAISE NOTICE 'Skipped creating index on orders.driver_id - column does not exist';
  END IF;
END $$;

-- ============================================================================
-- STEP 5: RLS Policies for drivers
-- ============================================================================
...
-- ============================================================================
-- STEP 6: RLS Policies for delivery_tracking
-- ============================================================================
ALTER TABLE public.delivery_tracking ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Customers can view their order tracking" ON public.delivery_tracking;
...
DROP POLICY IF EXISTS "Drivers can view their assigned deliveries" ON public.delivery_tracking;
...
DROP POLICY IF EXISTS "Drivers can update their assigned deliveries" ON public.delivery_tracking;
...
DROP POLICY IF EXISTS "Service role can manage delivery tracking" ON public.delivery_tracking;
CREATE POLICY "Service role can manage delivery tracking"
  ON public.delivery_tracking FOR ALL
  USING (auth.role() = 'service_role');

-- ============================================================================
-- STEP 7: RLS Policies for delivery_location_history
-- ============================================================================
ALTER TABLE public.delivery_location_history ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Users can view location history for their orders" ON public.delivery_location_history;
...
DROP POLICY IF EXISTS "Service role can manage location history" ON public.delivery_location_history;
CREATE POLICY "Service role can manage location history"
  ON public.delivery_location_history FOR ALL
  USING (auth.role() = 'service_role');

-- ============================================================================
-- STEP 8: RLS Policies for delivery_photos
-- ============================================================================
...
DROP POLICY IF EXISTS "Service role can manage delivery photos" ON public.delivery_photos;
CREATE POLICY "Service role can manage delivery photos"
  ON public.delivery_photos FOR ALL
  USING (auth.role() = 'service_role');

-- ============================================================================
-- STEP 9: RLS Policies for order_chat
-- ============================================================================
ALTER TABLE public.order_chat ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Users can view chat for their orders" ON public.order_chat;
...
DROP POLICY IF EXISTS "Users can send messages in their order chats" ON public.order_chat;
...
DROP POLICY IF EXISTS "Service role can manage order chat" ON public.order_chat;
CREATE POLICY "Service role can manage order chat"
  ON public.order_chat FOR ALL
  USING (auth.role() = 'service_role');

-- ============================================================================
-- STEP 10: RLS Policies for driver_earnings
-- ============================================================================
...
DROP POLICY IF EXISTS "Service role can manage driver earnings" ON public.driver_earnings;
CREATE POLICY "Service role can manage driver earnings"
  ON public.driver_earnings FOR ALL
  USING (auth.role() = 'service_role');

-- ============================================================================
-- STEP 11: RLS Policies for driver_shifts
-- ============================================================================
ALTER TABLE public.driver_shifts ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Drivers can view their own shifts" ON public.driver_shifts;
...
DROP POLICY IF EXISTS "Drivers can manage their own shifts" ON public.driver_shifts;
...
DROP POLICY IF EXISTS "Drivers can update their own shifts" ON public.driver_shifts;
...
DROP POLICY IF EXISTS "Service role can manage driver shifts" ON public.driver_shifts;
...
BEGIN
  IF NEW.status = 'delivered' AND (OLD.status IS NULL OR OLD.status != 'delivered') THEN
    ...
    -- Record earnings (only if orders.driver_tip column exists)
    IF EXISTS (SELECT 1 FROM information_schema.columns 
               WHERE table_schema = 'public' 
               AND table_name = 'orders' 
               AND column_name = 'driver_tip') THEN
    ...
    ELSE
      INSERT INTO public.driver_earnings (driver_id, order_id, base_pay, tips, total)
      VALUES (NEW.driver_id, NEW.order_id, 5.00, 0.00, 5.00);
    END IF;
  END IF;
...
DROP TRIGGER IF EXISTS driver_stats_update_trigger ON public.delivery_tracking;
...
-- Function to update driver rating (only if driver_rating column exists)
...
DROP TRIGGER IF EXISTS driver_rating_update_trigger ON public.orders;
